...
INSERT INTO `alimentos` (`id`, `nome`, `unidade_id`, `calorias`, `proteinas`, `carboidratos`, `gorduras`) VALUES
(1, 'Ovo', 3, 155, 13.00, 1.10, 11.00),
(2, 'Peito de frango', 1, 165, 31.00, 0.00, 3.60),
(3, 'Arroz branco', 1, 130, 2.70, 28.00, 0.30),
(4, 'Arroz integral', 1, 112, 2.60, 23.00, 0.90),
(5, 'Aveia', 1, 389, 17.00, 66.00, 7.00),
(6, 'Banana', 3, 89, 1.10, 23.00, 0.30),
(7, 'Maçã', 3, 52, 0.30, 14.00, 0.20),
(8, 'Leite integral', 2, 61, 3.20, 5.00, 3.30),
(9, 'Leite desnatado', 2, 34, 3.40, 5.00, 0.10),
(10, 'Queijo muçarela', 1, 280, 22.00, 3.00, 22.00),
(11, 'Queijo branco', 1, 264, 18.00, 3.00, 21.00),
(12, 'Iogurte natural', 1, 59, 3.50, 5.00, 3.30),
(13, 'Pão integral', 3, 247, 13.00, 41.00, 4.20),
(14, 'Pão branco', 3, 265, 9.00, 49.00, 3.20),
(15, 'Batata inglesa', 1, 77, 2.00, 17.00, 0.10),
(16, 'Batata doce', 1, 86, 1.60, 20.00, 0.10),
(17, 'Macarrão', 1, 131, 5.00, 25.00, 1.10),
(18, 'Macarrão integral', 1, 124, 5.00, 26.00, 1.30),
(19, 'Feijão carioca', 1, 76, 4.80, 14.00, 0.50),
(20, 'Feijão preto', 1, 77, 4.50, 14.00, 0.50),
(21, 'Carne bovina', 1, 250, 26.00, 0.00, 15.00),
(22, 'Carne moída', 1, 250, 26.00, 0.00, 15.00),
(23, 'Atum', 1, 132, 28.00, 0.00, 1.00),
(24, 'Sardinha', 1, 208, 25.00, 0.00, 11.00),
(25, 'Alface', 1, 15, 1.40, 2.90, 0.20),
(26, 'Tomate', 1, 18, 0.90, 3.90, 0.20),
(27, 'Cenoura', 1, 41, 0.90, 10.00, 0.20),
(28, 'Brócolis', 1, 34, 2.80, 7.00, 0.40),
(29, 'Abobrinha', 1, 17, 1.20, 3.10, 0.30),
(30, 'Pepino', 1, 16, 0.70, 3.60, 0.10),
(31, 'Milho', 1, 96, 3.40, 21.00, 1.50),
(32, 'Ervilha', 1, 81, 5.00, 14.00, 0.40),
(33, 'Grão de bico', 1, 164, 9.00, 27.00, 2.60),
(34, 'Lentilha', 1, 116, 9.00, 20.00, 0.40),
(35, 'Castanha de caju', 1, 553, 18.00, 30.00, 44.00),
(36, 'Amendoim', 1, 567, 26.00, 16.00, 49.00),
(37, 'Pasta de amendoim', 1, 588, 25.00, 20.00, 50.00),
(38, 'Mel', 1, 304, 0.30, 82.00, 0.00),
(39, 'Açúcar', 1, 387, 0.00, 100.00, 0.00),
(40, 'Chocolate meio amargo', 1, 546, 4.90, 61.00, 31.00),
(41, 'Ovo', 3, 155, 13.00, 1.10, 11.00),
(42, 'Peito de frango', 1, 165, 31.00, 0.00, 3.60),
(43, 'Arroz branco', 1, 130, 2.70, 28.00, 0.30),
(44, 'Arroz integral', 1, 112, 2.60, 23.00, 0.90),
(45, 'Aveia', 1, 389, 17.00, 66.00, 7.00),
(46, 'Banana', 3, 89, 1.10, 23.00, 0.30),
(47, 'Maçã', 3, 52, 0.30, 14.00, 0.20),
(48, 'Leite integral', 2, 61, 3.20, 5.00, 3.30),
(49, 'Leite desnatado', 2, 34, 3.40, 5.00, 0.10),
(50, 'Queijo muçarela', 1, 280, 22.00, 3.00, 22.00),
(51, 'Queijo branco', 1, 264, 18.00, 3.00, 21.00),
(52, 'Iogurte natural', 1, 59, 3.50, 5.00, 3.30),
(53, 'Pão integral', 3, 247, 13.00, 41.00, 4.20),
(54, 'Pão branco', 3, 265, 9.00, 49.00, 3.20),
(55, 'Batata inglesa', 1, 77, 2.00, 17.00, 0.10),
(56, 'Batata doce', 1, 86, 1.60, 20.00, 0.10),
(57, 'Macarrão', 1, 131, 5.00, 25.00, 1.10),
(58, 'Macarrão integral', 1, 124, 5.00, 26.00, 1.30),
(59, 'Feijão carioca', 1, 76, 4.80, 14.00, 0.50),
(60, 'Feijão preto', 1, 77, 4.50, 14.00, 0.50),
(61, 'Carne bovina', 1, 250, 26.00, 0.00, 15.00),
(62, 'Carne moída', 1, 250, 26.00, 0.00, 15.00),
(63, 'Atum', 1, 132, 28.00, 0.00, 1.00),
(64, 'Sardinha', 1, 208, 25.00, 0.00, 11.00),
(65, 'Alface', 1, 15, 1.40, 2.90, 0.20),
(66, 'Tomate', 1, 18, 0.90, 3.90, 0.20),
(67, 'Cenoura', 1, 41, 0.90, 10.00, 0.20),
(68, 'Brócolis', 1, 34, 2.80, 7.00, 0.40),
(69, 'Abobrinha', 1, 17, 1.20, 3.10, 0.30),
(70, 'Pepino', 1, 16, 0.70, 3.60, 0.10),
(71, 'Milho', 1, 96, 3.40, 21.00, 1.50),
(72, 'Ervilha', 1, 81, 5.00, 14.00, 0.40),
(73, 'Grão de bico', 1, 164, 9.00, 27.00, 2.60),
(74, 'Lentilha', 1, 116, 9.00, 20.00, 0.40),
(75, 'Castanha de caju', 1, 553, 18.00, 30.00, 44.00),
(76, 'Amendoim', 1, 567, 26.00, 16.00, 49.00),
(77, 'Pasta de amendoim', 1, 588, 25.00, 20.00, 50.00),
(78, 'Mel', 1, 304, 0.30, 82.00, 0.00),
(79, 'Açúcar', 1, 387, 0.00, 100.00, 0.00),
(80, 'Chocolate meio amargo', 1, 546, 4.90, 61.00, 31.00);
