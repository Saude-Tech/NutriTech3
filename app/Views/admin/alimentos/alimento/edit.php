            ...
            <div class="max-w-4xl mx-auto px-4 lg:px-8 py-8">
                ...
                <div class="mb-8 animate-fade-in">
                    <div class="flex items-center gap-3 mb-4">
                        <a href="<?= base_url('admin/alimentos') ?>" class="p-2 hover:bg-gray-100 rounded-lg transition">
                            <svg class="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div>
                            <h1 class="text-4xl font-bold text-gray-900">
                                <?= isset($alimento['id']) ? 'Editar Alimento' : 'Novo Alimento' ?>
                            </h1>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 card-hover animate-fade-in">
                    <form action="<?= base_url('admin/alimentos/salvar/' . ($alimento['id'] ?? '')) ?>" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="form-group md:col-span-2">
                                    ...
                                    <input type="text" name="nome" class="form-input"
                                        value="<?= esc($alimento['nome'] ?? '') ?>" required>
                                </div>

                                <div class="form-group">
                                    <label class="form-label">Calorias (kcal)</label>
                                    <input type="number" name="calorias" class="form-input"
                                        value="<?= esc($alimento['calorias'] ?? '') ?>" required>
                                </div>

                                <div class="form-group">
                                    <label class="form-label">Proteínas (g)</label>
                                    <input type="number" name="proteinas" class="form-input"
                                        value="<?= esc($alimento['proteinas'] ?? '') ?>" required>
                                </div>

                                <div class="form-group">
                                    <label class="form-label">Carboidratos (g)</label>
                                    <input type="number" name="carboidratos" class="form-input"
                                        value="<?= esc($alimento['carboidratos'] ?? '') ?>" required>
                                </div>

                                <div class="form-group">
                                    <label class="form-label">Gorduras (g)</label>
                                    <input type="number" name="gorduras" class="form-input"
                                        value="<?= esc($alimento['gorduras'] ?? '') ?>" required>
                                </div>
                            </div>
                        </div>

                        <div class="flex gap-4 pt-6 border-t border-gray-200">
                            <a href="<?= base_url('admin/alimentos') ?>"
